...
function Home() {
  ...
  const engineeringItems = [
    { label: "Diseno", icon: <PenTool className="w-6 h-6" />, image: "/ingenieria-suministros/diseno.webp", color: "text-gray-600", bg: "bg-gray-50", summary: "Levantamiento tecnico, propuesta visual y solucion ajustada al piso de produccion.", points: ["Layout", "Concepto", "Viabilidad"] },
    { label: "Propuesta", icon: <FileText className="w-6 h-6" />, image: "/ingenieria-suministros/propuesta.webp", color: "text-red-600", bg: "bg-red-50", summary: "Documentacion clara para alcance, materiales, tiempos y criterios de entrega.", points: ["Alcance", "Materiales", "Cronograma"] },
    { label: "Prototipos", icon: <Beaker className="w-6 h-6" />, image: "/ingenieria-suministros/prototipos.webp", color: "text-red-600", bg: "bg-red-50", summary: "Validacion de ideas y componentes antes de ejecutar en produccion.", points: ["Prueba fisica", "Ajustes", "Validacion"] },
    { label: "Pruebas", icon: <CheckCircle2 className="w-6 h-6" />, image: "/ingenieria-suministros/pruebas.webp", color: "text-gray-600", bg: "bg-gray-50", summary: "Revision funcional y liberacion tecnica para operar con confianza.", points: ["Checklist", "Funcionamiento", "Liberacion"] },
  ];
  const supplyItems = [
    { title: "Herramientas", icon: <Wrench className="w-6 h-6" />, image: "/ingenieria-suministros/herramientas.webp", color: "text-gray-600", bg: "bg-gray-50", desc: "Equipo especializado para operacion, mantenimiento e instalacion.", points: ["Herramienta manual", "Equipo electrico", "Trabajo en campo"] },
    { title: "Refacciones", icon: <Settings className="w-6 h-6" />, image: "/ingenieria-suministros/refacciones.webp", color: "text-red-600", bg: "bg-red-50", desc: "Componentes originales o equivalentes para maquinaria y servicios auxiliares.", points: ["Mecanicas", "Electricas", "Criticas"] },
    { title: "Consumibles", icon: <Factory className="w-6 h-6" />, image: "/ingenieria-suministros/consumible1.webp", color: "text-gray-600", bg: "bg-gray-50", desc: "Materiales de uso diario para mantener la operacion en movimiento.", points: ["MRO", "Seguridad", "Inventario"] },
  ];
